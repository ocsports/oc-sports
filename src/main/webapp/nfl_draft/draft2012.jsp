...
<div id="divDraft" style="width:100%">
	<table cellspacing="20">
		<tr style="vertical-align:top">
			<td>
				<div id="divDraftList" class="win" style="width:500px; height:300px; overflow:auto">
				...
				<div id="divChat" class="win" style="margin-top:2em; width:500px">
                    <div id="divChatMsgs" style="padding:3px; margin-bottom:0.5em; background-color:#DDDDDD; font-size:9pt; border:1px solid #BBBBBB; width:490px; height:125px; overflow:auto">
                        <%
                        iter = chat.iterator();
                        while( iter.hasNext() ) {
                        ...
                        <tr>
                            <td style="text-align:left; padding-bottom:1em; border-right:0px">
                                <select id="playerPos" name="playerPos" style="font-size:10pt; width:12em" onchange="setPlayerList('POS')">
									...
									<option value="QB" style="font-size:10pt" <%=(playerPos.equals("QB") ? "SELECTED" : "")%>>Quarterback (QB)</option>
									<option value="RB" style="font-size:10pt" <%=(playerPos.equals("RB") ? "SELECTED" : "")%>>Running Back (RB)</option>
									<option value="WR" style="font-size:10pt" <%=(playerPos.equals("WR") ? "SELECTED" : "")%>>Wide Receiver (WR)</option>
									<option value="TE" style="font-size:10pt" <%=(playerPos.equals("TE") ? "SELECTED" : "")%>>Tight End (TE)</option>
									<option value="K" style="font-size:10pt" <%=(playerPos.equals("K") ? "SELECTED" : "")%>>Kickers (K)</option>
									<option value="DEF" style="font-size:10pt" <%=(playerPos.equals("DEF") ? "SELECTED" : "")%>>Defense (DEF)</option>
                                </select>
                                <select id="playerTeam" name="playerTeam" style="font-size:10pt; width:8em; margin-left:0.5em" onchange="setPlayerList('TEAM')">
									...
									<option value="DEN" style="font-size:10pt" <%=(playerTeam.equals("DEN") ? "SELECTED" : "")%>>DEN</option>
									<option value="GB" style="font-size:10pt"  <%=(playerTeam.equals("GB") ? "SELECTED" : "")%>>GB</option>
									<option value="HOU" style="font-size:10pt" <%=(playerTeam.equals("HOU") ? "SELECTED" : "")%>>HOU</option>
									<option value="IND" style="font-size:10pt" <%=(playerTeam.equals("IND") ? "SELECTED" : "")%>>IND</option>
									<option value="MIN" style="font-size:10pt" <%=(playerTeam.equals("MIN") ? "SELECTED" : "")%>>MIN</option>
									<option value="NE" style="font-size:10pt"  <%=(playerTeam.equals("NE") ? "SELECTED" : "")%>>NE</option>
...
<script language="javascript">
    ...
    var rosterPos = new Array("QB", "RB", "RB", "WR", "WR", "TE", "RB/WR", "K", "DEF", "BN", "BN", "BN", "BN", "BN", "BN");
            ...
            for(var k=0; k < picks.length; k++) {
                ...
                if( dataElem[1] == pickTeamName && usedPlayers.indexOf("|" + dataElem[2] + "|") == -1 ) {
                    if( dataElem[6].toUpperCase().indexOf(currPos) > -1 )
                        usePlayer = true;
                    else if( currPos == "RB/WR" && (dataElem[6].toUpperCase().indexOf("RB") > -1 || dataElem[6].toUpperCase().indexOf("WR") > -1) )
                        usePlayer = true;
                    if( currPos == "BN" )
                        usePlayer = true;
                }
