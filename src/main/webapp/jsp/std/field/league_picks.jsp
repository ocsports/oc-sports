...
<div id="divPicks" style="width:0; padding-top:1em; padding-bottom:3em">
        ...
        while( iter.hasNext() ) {
            ...
            if( gm.isPosted() ) {
                if(gm.getAwayScore() > gm.getHomeScore())
                    scoreDisplay += "<td nowrap=\"true\">" + awayModel.getAbrv() + "<br/>" + gm.getAwayScore() + "-" + gm.getHomeScore() + "</td>";
                else
                    scoreDisplay += "<td nowrap=\"true\">" + homeModel.getAbrv() + "<br/>" + gm.getHomeScore() + "-" + gm.getAwayScore() + "</td>";
            }
            else {
            ...
            if(ssm.isSpreadPublished()) {
                if(gm.getSpread() > 0)
                    spreadDisplay += "<td nowrap=\"true\">" + awayModel.getAbrv() + "<br/>-" + gm.getSpread() + "</td>";
                else
                    spreadDisplay += "<td nowrap=\"true\">" + homeModel.getAbrv() + "<br/>" + gm.getSpread() + "</td>";
            }
        }
        %>
        <tr class="hdr">
