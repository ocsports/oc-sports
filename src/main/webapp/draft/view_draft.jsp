...
<%
    ...
    String currPickURL = response.encodeURL(request.getContextPath() + "/draft/current_pick.jsp");
    String playerListURL = response.encodeURL(request.getContextPath() + "/draft/player_list.jsp");
    String draftListURL = response.encodeURL(request.getContextPath() + "/draft/draft_list.jsp");
    String teamRosterURL = response.encodeURL(request.getContextPath() + "/draft/team_roster.jsp");
    String makePickURL = response.encodeURL(request.getContextPath() + "/draft/make_selection.jsp");
    String showDraftURL = response.encodeURL(request.getContextPath() + "/draft/view_draft.jsp");
