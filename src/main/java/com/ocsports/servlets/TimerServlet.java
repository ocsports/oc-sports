...
/**
 * Servlet class to manage all of the global tasks which will run on a scheduled
 * basis; Servlet should be loaded at startup so the tasks are scheduled at the
 * earliest convenience; Each task may have a separate scheduled rate defined in
 * the web.xml file
 *
 * @author paulcharlton
 */
public class TimerServlet extends ServletBase {
    ...
    /**
     * adds a TimerMessage object to the static list of messages for the
     * TimerServlet
     *
    ...
    /**
     * Read the scheduled tasks and their intervals from the web.xml file,
     * written as parameters to the servlet; one parameter per class; the
     * parameter value is a comma-separated array for name(String) and
     ...
     * @param response
     * @param session
     * @throws com.ocsports.core.ProcessException
     */
     ...
     * @throws com.ocsports.core.ProcessException
     */
    public void timerStatus(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ProcessException {
     ...
     * @throws com.ocsports.core.ProcessException
     */
    public void enableTimer(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ProcessException {
        startTimer();
     ...
     * @throws com.ocsports.core.ProcessException
     */
    public void disableTimer(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ProcessException {
        endTimer();
        this.timerStatus(request, response, session);
    }
     ...
     * @throws com.ocsports.core.ProcessException
     */
    public void runTask(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ProcessException {
    ...
    /**
     * add a message to the TimerServlet message queue; This will also record a
     * log message
     *
