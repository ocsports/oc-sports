...
/**
 * Scheduled task to set default picks for users who did not make selections;
 * look for games which are already in progress but have not already been
 * processed by this same task earlier
 *
 * @author paulcharlton
 */
